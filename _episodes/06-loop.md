...
We can call the [loop variable]({{ page.root }}/reference/#loop-variable) (`char` in this case) anything we like, but
...
> {: .output}
>
> It is a good idea to choose variable names that are meaningful though, otherwise it would be more
